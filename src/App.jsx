...
import { 
  ...
  Download, HelpCircle, X, Target, LayoutDashboard 
} from 'lucide-react';
...
export default function App() {
  const [abaAtiva, setAbaAtiva] = useState('dashboard'); // 'dashboard' ou 'questoes'
  ...
  return (
    <div style={{ maxWidth: '500px', margin: '0 auto', color: '#e2e8f0', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        {abaAtiva === 'dashboard' ? (
          <>
            ...
            <header style={{ marginBottom: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h1 style={{ fontSize: '1.5rem', color: '#60a5fa', display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
                  <BookOpen /> ApexStudy Axios
                </h1>
                <p style={{ color: '#94a3b8', fontSize: '0.8rem', margin: '2px 0 0 0' }}>Seu progresso diário em foco.</p>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              <h3 style={{ fontSize: '1rem', color: '#cbd5e1', margin: 0 }}>Matérias Agendadas</h3>
              <button
      ...
      <nav style={{
        ...
        <button
          ...
          style={{
            background: 'none',
            border: 'none',
            color: abaAtiva === 'dashboard' ? '#60a5fa' : '#64748b',
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            gap: '4px',
            fontSize: '0.75rem',
            fontWeight: abaAtiva === 'dashboard' ? 'bold' : 'normal',
            cursor: 'pointer'
          }}
        >
        ...
        <button
          ...
          style={{
            background: 'none',
            border: 'none',
            color: abaAtiva === 'questoes' ? '#60a5fa' : '#64748b',
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            gap: '4px',
